...
class SnappyClassifiedBottomNavScreen1 extends StatelessWidget {
  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      ...
      PersistentBottomNavBarItem(
          ...
          inactiveColor: Colors.white,
          titleStyle: TextStyle(fontFamily: "PoppinsRegular",fontSize: 12,color: Colors.white
          ),
